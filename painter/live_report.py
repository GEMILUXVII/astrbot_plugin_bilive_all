        ...
        if config.fans_change or config.fans_medal_change or config.guard_change:
            ...
            if config.fans_change:
                ...
                if diff > 0:
                    ...
                    pic.draw_text([f"粉丝: {before_str} → {after_str} ", "(+0)"], [Color.BLACK, Color.GRAY])
            ...
            if config.fans_medal_change:
                ...
                if diff > 0:
                    ...
                    pic.draw_text([f"粉丝团: {before_str} → {after_str} ", "(+0)"], [Color.BLACK, Color.GRAY])
            ...
            if config.guard_change:
                ...
                if diff > 0:
                    ...
                    pic.draw_text([f"大航海: {before_str} → {after_str} ", "(+0)"], [Color.BLACK, Color.GRAY])
